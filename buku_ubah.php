    ...
    <div class="col-md-12">
        <form method="post">
            ...
            if(isset($_POST['submit'])) {
                ...
                $stok = $_POST['stok'];
                $query = mysqli_query($koneksi, "UPDATE buku SET kategoriID='$id_kategori', judul='$judul', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit', deskripsi='$deskripsi', stok='$stok' WHERE id_buku=$id");
                    ...
                    <select name="id_kategori" class="form-control">
                        <?php
                            ...
                            while($kategori = mysqli_fetch_array($kat)){
                                ?>
                                <option <?php if ($kategori['id_kategori'] == $data['kategoriID']) echo 'selected';?> value="<?php echo $kategori['id_kategori']; ?>"><?php echo $kategori['kategori']; ?></option>
                                <?php    
                            }
                        ?>
                        </select>
