                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <?php
                                            if(isset($_POST['register'])){
                                                ...
                                                if($insert){
                                                    echo '<script>alert("Selamat, Register telah berhasil. Silahkan login");</script>';
                                                }else{
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                 ...
                                                 <input class="form-control py-4" type="text" required name="email" placeholder="Masukkan Email" required />
                                            </div>
                                            <div class="form-group">
